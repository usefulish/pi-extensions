...
| [`pi-hub`](./pi-hub) | 0.1.0 | Interactive installer CLI — `npx pi-hub` browses the @bacnh85 catalog, searches npm `keywords:pi-package`, multi-selects, and installs via `pi install`. |
